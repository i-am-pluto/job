...
2026-05-28: Nightly workflow/Naukri/Instahyre/LinkedIn — added per-agent token/tool budgets, forced sequential APPLY order with Naukri then Instahyre priority, converted DB writes to 3-4 app flushes, and removed Naukri profile boost to prevent quota burn.
2026-05-28: naukri/SKILL.md — added direct-apply detection pattern, chatbot handling, success confirmation check, low-salary skip rule, and note that ~70-80% of jobs redirect to company site
